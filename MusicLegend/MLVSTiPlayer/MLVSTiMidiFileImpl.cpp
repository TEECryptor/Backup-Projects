...
//	Introduce: The implement file of class CMLVSTiMidiFileImpl
//	Date: 2010-05-17
//--------------------------------------------------
#include "stdafx.h"
#include "MLVSTiMidiFileImpl.h"
//--------------------------------------------------
CMLVSTiMidiFileImpl::CMLVSTiMidiFileImpl(void)
 : m_dwFormat(1)
 , m_dwTrackCount(0)
 , m_dwTimeDivision(0)
 , m_dwCurrentTempo(0)
 ...
 , m_dwPlayingThreadID(0)
 , m_hPlayingThread(NULL)
 , m_hPlayingEvent(NULL)
{
}
//--------------------------------------------------
CMLVSTiMidiFileImpl::~CMLVSTiMidiFileImpl(void)
...
//--------------------------------------------------
void CMLVSTiMidiFileImpl::GetMidiFileInfo(MidiFileInfo &Info)
{
	strcpy(Info.csFileName, m_csFileName);
}
//--------------------------------------------------


//--------------------------------------------------
BOOL CMLVSTiMidiFileImpl::LoadMidiFile(const char* lpszFileName)
{
	OFSTRUCT os;
	...
	strcpy(m_csFileName, lpszFileName);
...
//--------------------------------------------------
LPCTSTR CMLVSTiMidiFileImpl::GetFileName()
{
	return m_csFileName;
}
//--------------------------------------------------
DWORD CMLVSTiMidiFileImpl::GetMidiFormat()
{
	return m_dwFormat;
}
//--------------------------------------------------
DWORD CMLVSTiMidiFileImpl::GetTimeDivision()
{
	return m_dwTimeDivision;
}
//--------------------------------------------------
DWORD CMLVSTiMidiFileImpl::GetTempo()
{
	return m_dwCurrentTempo;
}
//--------------------------------------------------
DWORD CMLVSTiMidiFileImpl::GetDuration()
{
	return m_dwDuration;
}
//--------------------------------------------------
DWORD CMLVSTiMidiFileImpl::GetTrackCount()
{
	return m_dwTrackCount;
}
//--------------------------------------------------
DWORD CMLVSTiMidiFileImpl::GetEventCount()
{
	return (DWORD)m_paEvents.size();
}
//--------------------------------------------------
void CMLVSTiMidiFileImpl::GetEvents(LPMIDIEVENT lpEvents, 
								DWORD &dwCount)
{
	DWORD dwCopiedCnt = 0;
...
//--------------------------------------------------
DWORD CMLVSTiMidiFileImpl::GetMetaEventCount()
{
	return 0;
}
//--------------------------------------------------
void CMLVSTiMidiFileImpl::GetMetaEvents(LPMIDIEVENT lpEvents, 
									DWORD &dwCount)
{
}
//--------------------------------------------------
long CMLVSTiMidiFileImpl::PerpareEventsByDeltaTime(DWORD dwDeltaTime)
{
...
//--------------------------------------------------
long CMLVSTiMidiFileImpl::SendCurEventsToEffect()
{
...
//--------------------------------------------------
BOOL CMLVSTiMidiFileImpl::ParseMidiData(LPBYTE lpMidiData, DWORD dwByteSize)
{
...
//--------------------------------------------------
BOOL CMLVSTiMidiFileImpl::ParseMidiTracks(LPMIDITRACK lpTracks, DWORD dwTrackCount)
{
...
//--------------------------------------------------
BOOL CMLVSTiMidiFileImpl::GetTrackEvent(LPMIDITRACK lpTrack, LPMIDIEVENT lpEvent)
{
...
//--------------------------------------------------
BOOL CMLVSTiMidiFileImpl::GetTrackByte(LPMIDITRACK lpTrack, LPBYTE lpbyByte)
{
...
//--------------------------------------------------
BOOL CMLVSTiMidiFileImpl::GetTrackVDWord(LPMIDITRACK lpTrack, LPDWORD lpdw)
{
...
//--------------------------------------------------
void CMLVSTiMidiFileImpl::ClearMidiData()
{
