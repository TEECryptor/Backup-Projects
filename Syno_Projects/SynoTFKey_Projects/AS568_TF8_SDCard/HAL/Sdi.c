...
* Date         :	2011/07/11
* Version      :    v1.0
* Description  :    SDI Hardware Abstract Layer compatible with AS60x
* ModifyRecord :
****************************************************************************/
...
SDI_ERR SDI_Init(UINT8 nClkDiv)
{
	...
	ScmRegs.MODCLKCTRL |= 1<<ID_SDI;
	ScmRegs.MODRSTCTRL |= 1<<ID_SDI;
	
	GpioRegs.GPBUSE0.bit.GPB2 = MUX_SDI;
	GpioRegs.GPBUSE0.bit.GPB3 = MUX_SDI;
	GpioRegs.GPBUSE0.bit.GPB4 = MUX_SDI;
	GpioRegs.GPBUSE0.bit.GPB5 = MUX_SDI;
	GpioRegs.GPBUSE0.bit.GPB6 = MUX_SDI;
	GpioRegs.GPBUSE0.bit.GPB7 = MUX_SDI;
