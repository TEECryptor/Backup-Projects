 ...
 * ListViewCtrlEx.h
 * 
 * Interfaces of the classes "CListCtrlEx" and "CListViewEx"
 * (list control and list view with sort icons and colored sort column)
 * 
 * Date: 25.06.2009
 * 
 * Author(s):
...
class CListBase
{
  ...
  void                OnChildNotify        (UINT message, LPARAM lParam);
