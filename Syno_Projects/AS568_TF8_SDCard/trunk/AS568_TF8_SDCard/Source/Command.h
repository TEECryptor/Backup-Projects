...
#define EXPUBKEYID     0xFFF6 
#define EXPRIKEYID     0xFFF7
#define SIGNPUBKEYID   0xFFF8 
#define SIGNPRIKEYID   0xFFF9
...
#define SGD_DES			    0x00000600  //DES算法 加密算法，生成密钥时使用
#define SGD_DES_ECB	        0x00000601  //DES算法 ECB运算   
#define SGD_DES_CBC	        0x00000602  //DES算法 CBC运算   
#define SGD_DES3		    0x00000610  //3DES算法 加密算法，生成密钥时使用 
#define SGD_DES3_ECB	    0x00000611  //3DES算法 ECB运算   
#define SGD_DES3_CBC	    0x00000612  //3DES算法 CBC运算 
...
#define SGD_SHA256  		0x00000003  //SHA256 密码杂凑算法 
#define SGD_MD5  		    0x00000004  //MD5 密码杂凑算法 
 ...
 *  容器属性结构体
 */
typedef struct _CONTAINERINFOEX
{
...
#define	CMD_GENERATE_SYMMKEY		0xA3	//直接生成一个对称密钥(供P11使用)
...
void CMD_GetContainerInfoEx(void);
