...
/*    block_dns_message_t data = {
	...
	block_dns_message_t data;
	data.header.message_id = add ? msg_add_block_dns : msg_del_block_dns;
	data.header.size = sizeof(block_dns_message_t);
	data.header.type = (message_type_t)0;
	data.iface.index = index;
	memset(data.iface.name, 0, 256);
/////////////////////YYF/////////////////////////////////////////////////
