 ...
 */
/*
 * RCSID:       $Id: mutex.h,v 1.2 2000/01/31 18:09:02 lbe Exp $
 * Source:      $Source: /usr/cvsroot/pkcs11/libgpkcs11/mutex.h,v $
...
CK_DECLARE_I_FUNCTION(CK_RV, I_CreateMutex)(
  CK_VOID_PTR_PTR ppMutex  /* location to receive ptr to mutex */
);

CK_DECLARE_I_FUNCTION(CK_RV, I_DestroyMutex)(
  CK_VOID_PTR pMutex  /* ptr to mutex */
);

CK_DECLARE_I_FUNCTION(CK_RV, I_LockMutex)(
  CK_VOID_PTR pMutex  /* ptr to mutex */
);

CK_DECLARE_I_FUNCTION(CK_RV, I_UnlockMutex)(
  CK_VOID_PTR pMutex  /* ptr to mutex */
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_CreateMutex)(
  CK_VOID_PTR_PTR ppMutex  /* location to receive ptr to mutex */
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_DestroyMutex)(
  CK_VOID_PTR pMutex  /* ptr to mutex */
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_LockMutex)(
  CK_VOID_PTR pMutex  /* ptr to mutex */
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_UnlockMutex)(
  CK_VOID_PTR pMutex  /* ptr to mutex */
);
