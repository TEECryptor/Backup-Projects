...
static char RCSID[]="$Id: error.c,v 1.11 2000/06/05 11:43:43 lbe Exp $";
...
/* {{{ CI_ErrorStr */
CK_DEFINE_I_FUNCTION(CK_C_CHAR_PTR, CI_ErrorStr)(
 CK_RV rv
)
{
  CK_ULONG i;
...
CK_DEFINE_I_FUNCTION(CK_C_CHAR_PTR, CI_MechanismStr)(
...
CK_DEFINE_I_FUNCTION(CK_CHAR_PTR, CI_PrintableByteStream)(
 ...
 */
CK_DEFINE_I_FUNCTION(CK_CHAR_PTR, CI_PrintTemplate)(
...
/* }}} */
/* {{{ CI_SetLoggingFile */
void CI_SetLoggingFile(CK_CHAR_PTR logFileName)
{
