...
)
{
    ...
    */
    ...
    {
        rv = ICA_TOK_EncryptInit(session_data, pMechanism, key_obj);
    }
...
)
{
    ...
    {
        rv = ICA_TOK_EncryptUpdate(session_data, pPart, ulPartLen, pEncryptedPart, pulEncryptedPartLen);
    }
...
)
{
    ...
    {
        rv = ICA_TOK_EncryptFinal(session_data, pLastEncryptedPart, pulLastEncryptedPartLen);
    }
