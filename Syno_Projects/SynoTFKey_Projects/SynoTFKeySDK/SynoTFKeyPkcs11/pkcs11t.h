/* $Id: pkcs11t.h,v 1.1 1999/06/16 09:46:11 lbe Exp $ */
/*
 * $Log: pkcs11t.h,v $
 * Revision 1.1  1999/06/16 09:46:11  lbe
 * reorder files
 *
 * Revision 1.2  1998/10/12 10:08:20  lbe
 * clampdown
 *
 * Revision 1.1  1998/07/02 17:24:08  lbe
 * Initial revision
 *
 * Revision 1.1  1998/05/19 10:08:49  sage
 * Initial revision
 *
 */
...
typedef struct CK_SLOT_INFO {
  CK_CHAR       slotDescription[64];  /* 槽的字符串描述 */
  CK_CHAR       manufacturerID[32];   /* 槽生产者的ID */
  CK_FLAGS      flags;	/* 用于提供槽能力的位标志 */
...
#define CKF_SERIAL_SESSION      0x00000004  /* 该标志提供逆向兼容，并始终设置为真 */
...
#define CKM_RSA_PKCS_KEY_PAIR_GEN      0x00000000	/* PKCS#1 RSA 密钥对生成机制 */
