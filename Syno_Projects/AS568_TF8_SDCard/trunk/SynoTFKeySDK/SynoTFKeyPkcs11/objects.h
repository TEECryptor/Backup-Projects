 ...
 */
/*
 * RCSID:       $Id: objects.h,v 1.8 2000/03/08 09:59:08 lbe Exp $
 * Source:      $Source: /usr/cvsroot/pkcs11/libgpkcs11/objects.h,v $
 * Last Delta:  $Date: 2000/03/08 09:59:08 $ $Revision: 1.8 $ $Author: lbe $
...
CK_DECLARE_I_FUNCTION(CK_RV, CI_InternalCreateObject)(
  CK_I_SESSION_DATA_PTR session_data,
  CK_I_OBJ_PTR pNewObject,
  CK_OBJECT_HANDLE_PTR phObject
);

/* Insertion a handle in session object list we need more than onece, hence this is done in sepparate function */
...
CK_DECLARE_I_FUNCTION(CK_RV, CI_InternalDestroyObject)(
  CK_I_SESSION_DATA_PTR session_data,
  CK_OBJECT_HANDLE hObject,
  CK_BBOOL destroy_persistent /* permanently destroy a persistent object */
);

CK_DECLARE_I_FUNCTION(CK_BBOOL, CI_MatchObject)(
  CK_I_OBJ_PTR pTemplate,
  CK_I_OBJ_PTR object
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_ReturnObj)(
  CK_I_SESSION_DATA_PTR session_data,
  CK_OBJECT_HANDLE hObject,
  CK_I_OBJ_PTR CK_PTR ppStoredObj
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_ReturnSession)(
...
CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjInitialize)(
 void
);

/** translate the CKA_ Attributes into CK_IA_ ones */
CK_DECLARE_I_FUNCTION(CK_RV, CI_TranslateAttribute)(
  CK_ATTRIBUTE_TYPE CkAttrib,
  CK_ATTRIBUTE_TYPE CK_PTR pIAtrrib
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_TranslateIntAttribute)(
 ...
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_AttributeValid)(
  CK_ATTRIBUTE_TYPE Attribute,
  CK_OBJECT_CLASS  ObjClass,
  CK_BBOOL CK_PTR pValid
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjCreateObj)(
  CK_I_OBJ_PTR CK_PTR ppNewObj
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjSetAttributeValue)(
...
CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjSetIntAttributeValue)(
  CK_I_OBJ_PTR pObject,
...
/**
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjSetAttribute)(
  CK_I_OBJ_PTR pObject,
 ...
 *
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjSetIntBool)(
  CK_I_OBJ_PTR pObject ,
 ...
 * @param
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjGetAttributeValue)(
  CK_I_OBJ_PTR pObject,
  CK_ATTRIBUTE_TYPE AttributeType,
  CK_BYTE_PTR pValue,
...
/**
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjGetIntAttributeValue)(
  CK_I_OBJ_PTR pObject ,
  CK_ATTRIBUTE_TYPE InternalAttributeType,
  CK_BYTE_PTR pValue,
  CK_ULONG_PTR pulValueLen
 ...
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjReadTemplate)(
  CK_I_OBJ_PTR  pObject,
...
/** copy an object.
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjCopyObject)(
  CK_I_OBJ_PTR pTargetObject,
  CK_I_OBJ_PTR pSourceObject
);

/* destroy an object. */
CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjDestroyObj)(
       CK_I_OBJ_PTR pObject
);
 ...
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjMergeObj)(
       CK_I_OBJ_PTR pTargetObject,
       CK_I_OBJ_PTR pSourceObject,
       CK_BBOOL overwrite
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjDeleteAttribute)(
       CK_I_OBJ_PTR pObject,
       CK_ATTRIBUTE_TYPE Attribute
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjDeleteIntAttribute)(
       CK_I_OBJ_PTR pObject,
       CK_ATTRIBUTE_TYPE InternalAttribute
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjDumpObj)(
      CK_I_OBJ_PTR pObject,
      FILE CK_PTR pOut
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjVerifyObj)(
 CK_I_OBJ_PTR pObject
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjFinalize)(
 void
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjAttribCount)(
 CK_I_OBJ_PTR pObject,
 CK_ULONG CK_PTR pCount
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjAttribIter)(
 CK_I_OBJ_PTR pObject,
 CK_I_HASH_ITERATOR_PTR CK_PTR pIterator
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_ObjAttribIterDeRef)(
 ...
 */
CK_DECLARE_I_FUNCTION(CK_RV,CI_ObjTemplateInit)(
 ...
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_ContainerAddObj)(
 ...
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_ContainerDelObj)(
 CK_I_HASHTABLE_PTR container,
 CK_ULONG key
);
...
CK_DEFINE_I_FUNCTION(CK_RV, CI_TokenObjDelete)(
  CK_I_SESSION_DATA_PTR session_data,
  CK_OBJECT_HANDLE phObject
);

CK_DEFINE_I_FUNCTION(CK_RV, CI_TokenObjCommit)(
  CK_I_SESSION_DATA_PTR session_data,
  CK_OBJECT_HANDLE phObject
);
