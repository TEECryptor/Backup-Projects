...
//--------------------------------------------
LONG CHttpDownloadStreamTask::SetThreadCnt(DWORD dwThreadCnt)
{
	// Can't set thread count to stream task
	return HTTP_E_CANTSET_THREADCNT;
}
//--------------------------------------------
//	Name:GetThreadCnt
//	Introduce:Return the thread count of this task.
//--------------------------------------------
DWORD CHttpDownloadStreamTask::GetThreadCnt()
{
	return (DWORD)m_arDownloadThread.size();
}
//--------------------------------------------
/*
//--------------------------------------------
												...
												DWORD dwDataLength)
{
	...
	pDownloadThread->SetDownloadInfo(m_hConnect, m_hTargetFile, NULL, &info);
...
//--------------------------------------------
LONG CHttpDownloadStreamTask::OnStart()
{
	CHttpDownloadThread* pThread = NULL;
	for (DownloadThreadPtrArray::iterator it = m_arDownloadThread.begin();
		 it != m_arDownloadThread.end();
