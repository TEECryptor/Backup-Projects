 ...
 */
/*
 * RCSID:       $Id: hash.h,v 1.2 2000/01/31 18:09:02 lbe Exp $
 * Source:      $Source: /usr/cvsroot/pkcs11/libgpkcs11/hash.h,v $
...
CK_DECLARE_I_FUNCTION(CK_RV, CI_HashGetEntry)(
  CK_I_HASHTABLE_PTR pHashTable,  /* returned ptr to hash table */
  CK_ULONG key,                /* key of data, base for hash */
  CK_VOID_PTR_PTR val         /* returned pointer to data*/
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_HashRemoveEntry)(
  CK_I_HASHTABLE_PTR pHashTable,  /* returned ptr to hash table */
  CK_ULONG key                /* key of data to be deleted */
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_HashEntryExists)(
  CK_I_HASHTABLE_PTR pHashTable,  /* returned ptr to hash table */
  CK_ULONG key                /* key of data to be deleted */
);

CK_DECLARE_I_FUNCTION(CK_CHAR_PTR, CI_HashtableToString)(
  CK_I_HASHTABLE_PTR pHashTable  /* returned ptr to hash table */
);
 ...
 */
CK_DECLARE_I_FUNCTION(CK_ULONG, CI_string_hash)(
  CK_CHAR_PTR string
);
 ...
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_HashIterateInit)(
...
CK_DECLARE_I_FUNCTION(CK_RV, CI_HashIterateInc)(
 ...
 * NULL_PTR 
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_HashIterateDeRef)(
 CK_I_HASH_ITERATOR_PTR pIterator,
 CK_ULONG_PTR pKey,
 ...
 * hash table.
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_HashIterateDel)(
 CK_I_HASH_ITERATOR_PTR pIterator
);

/* check the state of the iterator */
CK_DECLARE_I_FUNCTION(CK_BBOOL, CI_HashIterValid)(
 CK_I_HASH_ITERATOR_PTR pIterator
);

/* clear the iterator */
CK_DECLARE_I_FUNCTION(CK_RV, CI_HashIterateDelete)(
 CK_I_HASH_ITERATOR_PTR pIterator
);

/* CI_HashIterateDup */
CK_DECLARE_I_FUNCTION(CK_RV, CI_HashIterateDup)(
 CK_I_HASH_ITERATOR_PTR pIterator,
...
CK_DECLARE_I_FUNCTION(CK_RV, CI_NewHandle)(
