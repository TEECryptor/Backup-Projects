...
/* Common Definition */
#define	BMHOIST_USER_GROUP_ADMIN	1

typedef std::list<CString> lstString;
...
BOOL	FillComboBoxFromTable(CString strSQL, CString strColumnName, CString strDefault, CComboBox* pComboBox);
