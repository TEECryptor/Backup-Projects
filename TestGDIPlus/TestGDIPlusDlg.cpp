...
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CTestGDIPlusDlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CTestGDIPlusDlg, CDialog)
	//{{AFX_MSG_MAP(CTestGDIPlusDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_WM_TIMER()
...
BOOL CTestGDIPlusDlg::OnInitDialog()
{
   ...
   // Create an Image object.
	pBKImage = Image::FromFile(L"bk.png");
...
{/*
 ...
 //  graphics.DrawImage(&image, 10, 10);
   ...
   graphics.DrawImage(pBKImage, desRc, 0.0f, 0.0f, 1024.0f, 768.0f, UnitPixel, NULL, NULL, NULL);
...
void CTestGDIPlusDlg::OnTimer(UINT nIDEvent) 
{	
	Invalidate(FALSE);
