...
public:
	...
	afx_msg void OnEnChangeEditWebendheight();
...
private:	
	...
	//-------------------------------------------------------------------
public:
	afx_msg void OnCbnSelchangeComboGirderW1();
	afx_msg void OnCbnSelchangeComboGirderT1();
	afx_msg void OnCbnSelchangeComboMaterial();
	afx_msg void OnCbnSelchangeComboRailstyle();
	afx_msg void OnCbnSelchangeComboW3();
};
//-----------------------------------------------------------------------
