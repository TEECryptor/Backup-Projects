...
template <> class xBaseStrFunc<wchar_t , std::wstring>
{
public:
	...
	static void       appendReturn(std::wstring& _str) {_str.append(L"\r"); };    
	static void       appendTab(std::wstring& _str)    {_str.append(L"\t"); };  
	static void       appendNewLine(std::wstring& _str){_str.append(L"\n"); };  
};

template <> class xBaseStrFunc<char, std::string>
{
public:
	...
	static void    appendReturn(std::string& _str) { _str.append("\r"); }    
	static void    appendTab(std::string& _str)    { _str.append("\t"); };  
	static void    appendNewLine(std::string& _str){ _str.append("\n"); };  
};

typedef bool (*FUNC_IS_ACCEPT)(unsigned int ch);

bool  XEvol_IsReadalbeChar(unsigned int ch);
...
public:
	...
	int stringEqualSpaceLeader(const _CharT* pBase,const _CharT* tag,bool ignoreCase)
	{
        const _CharT* p = pBase;
		p += skipWhiteSpace(p);
