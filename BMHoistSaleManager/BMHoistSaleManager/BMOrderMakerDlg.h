...
private:
	...
	BOOL	ExportMainGirderToWordTemplate(CString strMainGirderFolder);
	BOOL	ExportEndCarriageToWordTemplate(CString strEndCarFolder);
	BOOL	ExportSteelStructureToWordTemplate(CString strSteelStructureFolder);
	//-------------------------------------------------------------------
private:
...
public:
	...
	afx_msg void OnBnClickedBtnOrderdlgMaingirder();
	afx_msg void OnBnClickedBtnOrderdlgSteelstructure();
};
//-----------------------------------------------------------------------
