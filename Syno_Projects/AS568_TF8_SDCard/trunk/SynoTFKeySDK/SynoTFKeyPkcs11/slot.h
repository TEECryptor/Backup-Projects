...
*/
CK_DECLARE_I_FUNCTION(CK_RV, CI_GetTokenData)(
  CK_ULONG ulSlotID,
...
*/
CK_DECLARE_I_FUNCTION(CK_RV, CI_GetSlotData)(
  CK_ULONG ulSlotID,
 ...
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_RemoveToken)(
 CK_ULONG slotID
);
...
*/
CK_DECLARE_I_FUNCTION(CK_RV, CI_InitEventHandler)(
 void
);

/** Finalize the event handling.
*/
CK_DECLARE_I_FUNCTION(CK_RV, CI_FinalizeEventHandler)(
 void
);
 ...
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_RegisterEventSink)(
 CK_SLOT_ID slot, 
 CK_I_EventActionCallback action,  
 CK_VOID_PTR user_data, 
...
*/
CK_DECLARE_I_FUNCTION(CK_RV, CI_RemoveEventSink)(
 ...
 *                    CKR_GENERAL_ERROR in all other error conditions.
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_SendSlotEvent)(
 CK_SLOT_ID slot, 
 CK_VOID_PTR user_data, 
 ...
 *                    CKR_GENERAL_ERROR in all other error conditions.
*/
CK_DECLARE_I_FUNCTION(CK_RV, CI_TriggerEvent)(
 CK_I_EVENT_INFO_PTR event, 
 CK_VOID_PTR user_data, 
 CK_CHAR_PTR event_label
);
