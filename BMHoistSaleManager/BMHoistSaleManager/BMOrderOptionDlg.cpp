...
void CBMOrderOptionDlg::InitDataControls()
{
	...
	if (_T("S") == m_pCraneCalculator->m_CalcDatalst.GA12)
		strHoistFreeText.Format(_T("%d"), m_pCraneCalculator->m_CalcDatalst.MA2);
	else
		strHoistFreeText.Format(_T("%s"), m_pCraneCalculator->m_CalcDatalst.DA5);
	m_DetailOrderCtrls[eComponentType_Hoist].SetInitData(m_pCraneCalculator->m_CalcDatalst.GA2, m_pCraneCalculator->m_CalcDatalst.T25, strHoistFreeText);
	if (!m_pCraneCalculator->m_bOnlyHoist)
	{
		CString strEndCarFreeText;
		strEndCarFreeText.Format(_T("%d/%s/Q%d"), m_pCraneCalculator->m_CalcDatalst.DB8, m_pCraneCalculator->m_CalcDatalst.DB7, m_pCraneCalculator->m_CalcDatalst.DB61);
		m_DetailOrderCtrls[eComponentType_EndCar].SetInitData(2, m_pCraneCalculator->m_CalcDatalst.T26, strEndCarFreeText);
		m_DetailOrderCtrls[eComponentType_BridgeDri].SetInitData(m_pCraneCalculator->m_CalcDatalst.DB4, m_pCraneCalculator->m_CalcDatalst.DB3);
		m_DetailOrderCtrls[eComponentType_BridgePannel].SetInitData(1, m_pCraneCalculator->m_CalcDatalst.EG1);
		m_DetailOrderCtrls[eComponentType_Fastoon].SetInitData(1, m_pCraneCalculator->m_CalcDatalst.EG2);
		m_DetailOrderCtrls[eComponentType_OperateUnit].SetInitData(1, m_pCraneCalculator->m_CalcDatalst.EG3);
		m_DetailOrderCtrls[eComponentType_CranePower].SetInitData(1, m_pCraneCalculator->m_CalcDatalst.EG5);
	}
