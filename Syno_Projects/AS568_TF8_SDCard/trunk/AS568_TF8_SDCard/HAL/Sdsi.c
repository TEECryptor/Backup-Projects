/**********************************************************************************
* File name    :	Sdsi.c
* Function     :	The SDSI driver for SY03
* Author       : 	coins
* Date         :	2014/02/17
* Version      :    v1.0
* Description  :	
...
* Functon
**********************************************************************************/
//void print_sdsi_regs(void)
//{
//	printf("SDSI Registers:\n");
//	printf("STATUS(0x%x) = 0x%x\n",&SdsiRegs.STATUS.all, SdsiRegs.STATUS.all);
//	printf("CTRL(0x%x) = 0x%x\n",&SdsiRegs.CTRL.all, SdsiRegs.CTRL.all);
//	printf("ADDR_DN(0x%x) = 0x%x\n",&SdsiRegs.ADDR_DN, SdsiRegs.ADDR_DN);
//	printf("ADDR_UP(0x%x) = 0x%x\n",&SdsiRegs.ADDR_UP, SdsiRegs.ADDR_UP);
//	printf("INT_FLAG(0x%x) = 0x%x\n",&SdsiRegs.INT_FLAG.all, SdsiRegs.INT_FLAG.all);
//	printf("INT_EN(0x%x) = 0x%x\n",&SdsiRegs.INT_EN.all, SdsiRegs.INT_EN.all);
//	printf("BLK_LEN(0x%x) = 0x%x\n",&SdsiRegs.BLK_LEN, SdsiRegs.BLK_LEN);
//	printf("CMD_NUM(0x%x) = 0x%x\n",&SdsiRegs.CMD_NUM, SdsiRegs.CMD_NUM);
//	printf("CMD_ARG(0x%x) = 0x%x\n",&SdsiRegs.CMD_ARG, SdsiRegs.CMD_ARG);
//	printf("CSR(0x%x) = 0x%x\n",&SdsiRegs.CSR.all, SdsiRegs.CSR.all);
//	printf("CID0(0x%x) = 0x%x\n",&SdsiRegs.CID0, SdsiRegs.CID0);
//	printf("CID1(0x%x) = 0x%x\n",&SdsiRegs.CID1, SdsiRegs.CID1);
//	printf("CID2(0x%x) = 0x%x\n",&SdsiRegs.CID2, SdsiRegs.CID2);
//	printf("CID3(0x%x) = 0x%x\n",&SdsiRegs.CID3, SdsiRegs.CID3);
//	printf("OCR(0x%x) = 0x%x\n",&SdsiRegs.OCR, SdsiRegs.OCR);
//	printf("VOLT_ACCP(0x%x) = 0x%x\n",&SdsiRegs.VOLT_ACCP, SdsiRegs.VOLT_ACCP);
//	printf("CSD0(0x%x) = 0x%x\n",&SdsiRegs.CSD0, SdsiRegs.CSD0);
//	printf("CSD1(0x%x) = 0x%x\n",&SdsiRegs.CSD1, SdsiRegs.CSD1);
//	printf("CSD2(0x%x) = 0x%x\n",&SdsiRegs.CSD2, SdsiRegs.CSD2);
//	printf("CSD3(0x%x) = 0x%x\n",&SdsiRegs.CSD3, SdsiRegs.CSD3);
//	printf("RCA(0x%x) = 0x%x\n",&SdsiRegs.RCA, SdsiRegs.RCA);
//	printf("ERASE_ADDR_ST(0x%x) = 0x%x\n",&SdsiRegs.ERASE_ADDR_ST, SdsiRegs.ERASE_ADDR_ST);
//	printf("ERASE_ADDR_ED(0x%x) = 0x%x\n",&SdsiRegs.ERASE_ADDR_ED, SdsiRegs.ERASE_ADDR_ED);
//}
/***************************************************************************
	...
	switch(gpSdsiDev->nSDPhyVer)
	{
		...
		case SD_PHY_V2_00:
			...
			else if(gpSdsiDev->nCapacity > SD_CAPACITY_K(44)) 	// SDSC
			{
				SdsiRegs.MEM_OCR.all = 0x00FF8000;										// SDSC
				SdsiRegs.CSD0 = 0x16804000;
				SdsiRegs.CSD1 = 0xB6D8FF80 | ((gpSdsiDev->nCapacity/8-1)<<30); 		// 60-80mA, 512-mult,   	
				SdsiRegs.CSD2 = 0x5B590002 | (((gpSdsiDev->nCapacity/8-1)>>2)&0x3FF);// class 0/2/4/5/7/8/10, 512B/block 
				SdsiRegs.CSD3 = 0x007F0032;												// CSD1.1, 80ms TAAC, 25Mbit/s
			}
			else if(gpSdsiDev->nCapacity == SD_CAPACITY_K(44)) 	// SDSC
			{
...
UINT8 SDSI_Init(P_SDSI_DEV pSdsiDev)
{
	UINT32 i = 0;
	// to select Pins 
	GpioRegs.GPBUSE1.bit.GPB10 = MUX_SDSI;		// DAT1	
	GpioRegs.GPBUSE1.bit.GPB11 = MUX_SDSI;		// DAT0	
	GpioRegs.GPBUSE1.bit.GPB12 = MUX_SDSI;		// CLK	
	GpioRegs.GPBUSE1.bit.GPB13 = MUX_SDSI;		// CMD
	GpioRegs.GPBUSE1.bit.GPB14 = MUX_SDSI;		// DAT3	
	GpioRegs.GPBUSE1.bit.GPB15 = MUX_SDSI;		// DAT2	
