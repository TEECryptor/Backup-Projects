...
void CBMHoistLayotsDlg::SetCurrentViewType(eLayoutViewType eViewType)
{
	...
	if (m_pCraneParam->m_CalcDatalst.HB2.IsEmpty())
		return;

	BOOL bResult = TRUE;
	CADOTable tbDimHoiSel;
	CStringW strOpenOperation;
	strOpenOperation.Format(L"SELECT * FROM %s WHERE HoiDimIndCod='%s'", m_stuDimHoistTables[eViewType][m_pCraneParam->m_eCraneType].strName, m_pCraneParam->m_CalcDatalst.HB213);
	bResult = tbDimHoiSel.OpenTable(g_pSettingDatabase->GetConnectionPtr(), strOpenOperation);
	if (FALSE == bResult)
		return;

	TCHAR tcH2[32] = {0};
	tbDimHoiSel.GetRecordCell(0, L"WgtHoi", (DWORD&)m_pCraneParam->m_CalcDatalst.HB227);
	tbDimHoiSel.GetRecordCell(0, L"b1",(DWORD&)m_pCraneParam->m_CalcDatalst.HB229);
	tbDimHoiSel.GetRecordCell(0, L"b2", (DWORD&)m_pCraneParam->m_CalcDatalst.HB230);
	tbDimHoiSel.GetRecordCell(0, L"b", (DWORD&)m_pCraneParam->m_CalcDatalst.HB228);
	tbDimHoiSel.GetRecordCell(0, L"h2", tcH2, 32);
	m_pCraneParam->m_CalcDatalst.HB231 = _ttol(tcH2);
...
void CBMHoistLayotsDlg::InitTableDataStruct()
{
	...
	m_stuDimHoistTables[eLayoutViewType_Main][eCraneType_GTZ].eID = eTableID_DimHoi_F;
	m_stuDimHoistTables[eLayoutViewType_Main][eCraneType_GTZ].strName = g_tcTableName[eTableID_DimHoi_F];
	m_stuDimHoistTables[eLayoutViewType_Main][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 50,  L"W",	IDS_DIMHOIST_W,	eTableDataType_String));
	m_stuDimHoistTables[eLayoutViewType_Main][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 50,  L"R",	IDS_DIMHOIST_R, eTableDataType_String));
	m_stuDimHoistTables[eLayoutViewType_Main][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 35,  L"W1",	IDS_DIMHOIST_W1,eTableDataType_String));
	m_stuDimHoistTables[eLayoutViewType_Main][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 40,  L"H2",	IDS_DIMHOIST_H2,eTableDataType_String));
	m_stuDimHoistTables[eLayoutViewType_Main][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 35,  L"H3",	IDS_DIMHOIST_H3,eTableDataType_String));
	m_stuDimHoistTables[eLayoutViewType_Main][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 40,  L"H4",	IDS_DIMHOIST_H4,eTableDataType_String));
	//
	m_stuDimHoistTables[eLayoutViewType_Side][eCraneType_GTZ].eID = eTableID_DimHoi_F;
	m_stuDimHoistTables[eLayoutViewType_Side][eCraneType_GTZ].strName = g_tcTableName[eTableID_DimHoi_F];
	m_stuDimHoistTables[eLayoutViewType_Side][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 50,  L"L",	IDS_DIMHOIST_L,	 eTableDataType_String));
	m_stuDimHoistTables[eLayoutViewType_Side][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 50,  L"b1",	IDS_DIMHOIST_B1, eTableDataType_DWORD));
	m_stuDimHoistTables[eLayoutViewType_Side][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 50,  L"b2",	IDS_DIMHOIST_B2, eTableDataType_DWORD));
	m_stuDimHoistTables[eLayoutViewType_Side][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 50,  L"C",	IDS_DIMHOIST_C,  eTableDataType_String));
	m_stuDimHoistTables[eLayoutViewType_Side][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 50,  L"H1",	IDS_DIMHOIST_H1, eTableDataType_String));
	//
	m_stuDimHoistTables[eLayoutViewType_Top][eCraneType_GTZ].eID = eTableID_DimHoi_F;
	m_stuDimHoistTables[eLayoutViewType_Top][eCraneType_GTZ].strName = g_tcTableName[eTableID_DimHoi_F];
	m_stuDimHoistTables[eLayoutViewType_Top][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 35,  L"m1",	IDS_DIMHOIST_M1, eTableDataType_String));
	m_stuDimHoistTables[eLayoutViewType_Top][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 40,  L"m2",	IDS_DIMHOIST_M2, eTableDataType_String));
	m_stuDimHoistTables[eLayoutViewType_Top][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 35,  L"m3",	IDS_DIMHOIST_M3, eTableDataType_String));
	m_stuDimHoistTables[eLayoutViewType_Top][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 30,  L"L1",	IDS_DIMHOIST_L1, eTableDataType_String));
	m_stuDimHoistTables[eLayoutViewType_Top][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 30,  L"S4",	IDS_DIMHOIST_S4, eTableDataType_String));
	m_stuDimHoistTables[eLayoutViewType_Top][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 30,  L"J1",	IDS_DIMHOIST_J1, eTableDataType_String));
	m_stuDimHoistTables[eLayoutViewType_Top][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 30,  L"J2",	IDS_DIMHOIST_J2, eTableDataType_String));
	m_stuDimHoistTables[eLayoutViewType_Top][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 30,  L"J3",	IDS_DIMHOIST_J3, eTableDataType_String));
	m_stuDimHoistTables[eLayoutViewType_Top][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 30,  L"J4",	IDS_DIMHOIST_J4, eTableDataType_String));
	m_stuDimHoistTables[eLayoutViewType_Top][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 30,  L"J5",	IDS_DIMHOIST_J5, eTableDataType_String));
	m_stuDimHoistTables[eLayoutViewType_Top][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 30,  L"X1",	IDS_DIMHOIST_X1, eTableDataType_String));
	m_stuDimHoistTables[eLayoutViewType_Top][eCraneType_GTZ].lstColumns.push_back(TableColumn(FALSE, 30,  L"X2",	IDS_DIMHOIST_X2, eTableDataType_String));
