...
// 
////////////////////////////////////////////////////////////////////////////////
bool ImageEx::InitAnimation(HWND hWnd, RECT rc)
{
...
bool ImageEx::DrawFrameGIF()
{
	...
	if (hDC)
	{
		...
		graphics.DrawImage(this, m_stuRect.left, m_stuRect.top, m_stuRect.right-m_stuRect.left, m_stuRect.bottom-m_stuRect.top);
	...
	long lPause = ((long*) m_pPropertyItem->value)[m_nFramePosition] * 20;
