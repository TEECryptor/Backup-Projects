...
BOOL CBMOfferOptionsDlg::OnInitDialog()
{
	...
	//
	m_DetailPricesCtrls[eComponentType_Hoist].SetInitData(m_pCraneCalculator->m_iNumOfHoist, m_pCraneCalculator->m_iHoistPrice, 0, m_pCraneCalculator->m_strHoistCode);
	if (!m_pCraneCalculator->m_bOnlyHoist)
	{
		m_DetailPricesCtrls[eComponentType_EndCar].SetInitData(2, m_pCraneCalculator->m_iEndCarPrice, 0, m_pCraneCalculator->GetEndCarDataText(), TRUE);
		m_DetailPricesCtrls[eComponentType_BridgeDri].SetInitData(m_pCraneCalculator->m_iNumOfMotor, m_pCraneCalculator->m_iBridgeDriverPrice, 0, m_pCraneCalculator->m_strDriverCode);
		m_DetailPricesCtrls[eComponentType_BridgePannel].SetInitData(1, m_pCraneCalculator->m_iCranePannelPrice, 0, m_pCraneCalculator->m_strCraPannelCode);
		m_DetailPricesCtrls[eComponentType_Fastoon].SetInitData(1, m_pCraneCalculator->m_iFastoonPrice, 0, m_pCraneCalculator->m_strFastoonCode);
		m_DetailPricesCtrls[eComponentType_OperateUnit].SetInitData(1, m_pCraneCalculator->m_iOperterUnitPrice, 0, m_pCraneCalculator->m_strOperterUnitCode);
		m_DetailPricesCtrls[eComponentType_CranePower].SetInitData(1, m_pCraneCalculator->m_iPowerSupplyPrice, 0, m_pCraneCalculator->m_strCraPowSupplyCode);
		m_DetailPricesCtrls[eComponentType_MainGirder].SetInitData(1, int(m_pCraneCalculator->m_iMainGirderPrice * m_pCraneCalculator->m_fGirder_mt/1000.0f), 0, m_pCraneCalculator->m_strMainGirderCode);
	}
