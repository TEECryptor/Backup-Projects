 ...
 */
/*
 * RCSID:       $Id: init.h,v 1.5 2000/01/31 18:09:02 lbe Exp $
 * Source:      $Source: /usr/cvsroot/pkcs11/libgpkcs11/init.h,v $
 * Last Delta:  $Date: 2000/01/31 18:09:02 $ $Revision: 1.5 $ $Author: lbe $
...
#include "cryptoki.h"
//#include "dll_wrap.h"	//Should be deleted!!!

CK_DECLARE_I_FUNCTION(CK_RV, CI_TokenInit)(
  void
);
#if 0
 ...
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_FindConfFile)(
);
 ...
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_InitDllTable)(
);
 ...
 * DLL table.
 */
CK_DECLARE_I_FUNCTION(token_init, CI_InitTokenDll)(
 ...
 */
CK_DECLARE_I_FUNCTION(CK_RV, CI_GetDllHandle)(
...
CK_DECLARE_I_FUNCTION(CK_RV, CI_UnloadDlls)(
  void
);

CK_DECLARE_I_FUNCTION(void, CI_TokenInit)(
  void
);

CK_DECLARE_I_FUNCTION(void, CI_ReadLogLevel)(
  void
 );

#define CK_I_WINDOWS_RC_FNAME "C:\\work\\ydsdk\\etc\\gpkcs11.ini"
#define CK_I_UNIX_RC_FNAME "mnt/sdcard/gpkcs11.rc"
...
CK_DECLARE_I_FUNCTION(CK_I_DLL_INFO_PTR, CK_I_DLL_INFO_new)(
  void
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_GetConfigString)(
  CK_CHAR_PTR SectionName,
  CK_CHAR_PTR FieldName,
  CK_CHAR_PTR CK_PTR value
);

CK_DECLARE_I_FUNCTION(CK_RV, CI_GetSignals)(
);
#endif//0
#endif /* _INIT_H */
