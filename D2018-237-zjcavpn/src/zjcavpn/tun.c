...
//////////////////YYF///////////////////////////////////////
    ...
    //};
	address_message_t addr;
	addr.header.message_id = (add ? msg_add_address : msg_del_address);
	addr.header.size = sizeof(address_message_t);
	addr.header.type = (message_type_t)0;
	addr.family = family;
	addr.iface.index = tt->adapter_index;
	memset(addr.iface.name, 0, 256);
//////////////////YYF///////////////////////////////////////
...
///////////////////////YYF////////////////////////////////////
    ...
    //    .addr_len = addr_len
    //};
	dns.header.message_id = (add ? msg_add_dns_cfg : msg_del_dns_cfg);
	dns.header.size = sizeof(address_message_t);
	dns.header.type = (message_type_t)0;
	dns.iface.index = tt->adapter_index;
	memset(dns.iface.name, 0, 256);
	memset(dns.domains, 0, 512);
	dns.family = AF_INET6;
...
/////////////////////YYF/////////////////////////////////////////////////
                ...
                //};
				msg.header.message_id = msg_flush_neighbors;
				msg.header.size = sizeof(flush_neighbors_message_t);
				msg.header.type = (message_type_t)0;
				msg.family = AF_INET;
				msg.iface.index = index;
				memset(msg.iface.name, 0, 256);
/////////////////////YYF/////////////////////////////////////////////////
