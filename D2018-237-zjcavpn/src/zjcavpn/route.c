...
/////////////////////YYF/////////////////////////////////////////////////
    ...
    //};
	msg.header.message_id = add ? msg_add_route : msg_del_route;
	msg.header.size = sizeof(route_message_t);
	msg.header.type = (message_type_t)0;
    msg.family = AF_INET,
    msg.prefix.ipv4.s_addr = htonl(r->network),
    msg.gateway.ipv4.s_addr = htonl(r->gateway),
    msg.iface.index = if_index;
	memset(msg.iface.name, 0, 256),
    msg.metric = (r->flags & RT_METRIC_DEFINED ? r->metric : -1);
/////////////////////YYF/////////////////////////////////////////////////
